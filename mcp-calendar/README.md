...
Outlook (Microsoft Graph), and iCloud (CalDAV) — to the OpenClaw gateway. A third, isolated
sidecar: it holds **no mail or drive credentials**, only its own per-calendar OAuth tokens / app
password.
...
`instance/gcal/`, `instance/mscal/`, and `instance/icloudcal/`, mounted only into this container.
